...
__DEFINE__(1659102872903, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1659102872904,"./event-store":1659102872905}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1659102872904, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1659102872905, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1659102872904,"./utils":1659102872906}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1659102872906, function(require, module, exports) {
...
return __REQUIRE__(1659102872903);
})()
